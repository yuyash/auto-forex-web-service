...
Tests the POST /api/auth/refresh endpoint using live_server.
"""
...
class TestTokenRefresh:
    ...
    def test_successful_token_refresh(self, live_server, test_user, auth_headers):
        ...
        url = f"{live_server.url}/api/auth/refresh"
    ...
    def test_refreshed_token_is_valid(self, live_server, test_user, auth_headers):
        ...
        refresh_url = f"{live_server.url}/api/auth/refresh"
        ...
        settings_url = f"{live_server.url}/api/settings/"
