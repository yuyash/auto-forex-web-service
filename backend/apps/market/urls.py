...
urlpatterns: List[URLPattern] = [
    ...
    path(
        route="accounts/<int:account_id>/refresh/",
        view=OandaAccountSnapshotRefreshView.as_view(),
        name="oanda_account_snapshot_refresh",
    ),
    path(
        route="accounts/<int:account_id>/refresh/<str:task_id>/",
        view=OandaAccountSnapshotRefreshStatusView.as_view(),
        name="oanda_account_snapshot_refresh_status",
    ),
