...
export interface OhlcOverlaySettings {
  sma20: boolean;
  sma50: boolean;
  ema12: boolean;
  ema26: boolean;
...
export const DEFAULT_OHLC_OVERLAY_SETTINGS: OhlcOverlaySettings = {
  sma20: true,
  sma50: false,
  ema12: false,
  ema26: false,
...
export type OverlaySettings = OhlcOverlaySettings;

export const DEFAULT_OVERLAY_SETTINGS = DEFAULT_OHLC_OVERLAY_SETTINGS;
...
export function useOhlcChartOverlays(
      ...
      if (overlays.volume) {
        ...
        volumeRef.current.setData(
          candles
            ...
            .map((candle) => ({
              time: candle.time as UTCTimestamp as Time,
              value: candle.volume!,
              color:
