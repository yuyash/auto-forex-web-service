 ...
 *
 * Main detail view for trading tasks using execution-based API endpoints.
...
import { EventsTable } from '../backtest/detail/EventsTable';
import { LogsTable } from '../backtest/detail/LogsTable';
import { TradesTable } from '../backtest/detail/TradesTable';
import { EquityChart } from '../backtest/detail/EquityChart';
import { MetricsChart } from '../backtest/detail/MetricsChart';
  ...
  return (
    <Container maxWidth={false} sx={{ py: 4 }}>
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        <ExecutionDataProvider taskId={taskId} taskType={TaskType.TRADING}>
