...
export function useTaskTrendOrchestration({
  ...
  const tradeTable = useTaskTrendTradesTable(replayData.trades, timezone);
  const longPositionsTable = useTaskTrendPositionsTable({
    positions: derivedData.longPositions,
  ...
  const shortPositionsTable = useTaskTrendPositionsTable({
    positions: derivedData.shortPositions,
    currentPrice: derivedData.currentPrice,
    pipSize,
  ...
  const selectionNavigation = useTaskSelectionNavigation({
    trades: replayData.trades,
    positions: derivedData.allPositions,
    selectedTradeId: panelState.selectedTradeId,
